...
class CriticNode12(nn.Module):
    def __init__(self):
        super(CriticNode12, self).__init__()
        # 定义完成功能所需的模�?
    ...
    def optimize(self, byteData):
        ...
        for _, sample in byteData.items():
            ...
            torch.save(self.criticDict, "{}/{}.dict".format("dict", "criticDict"))
            torch.save(self.actorDict, "{}/{}.dict".format("dict", "actorDict"))
        ...
        self.load("dict12", "criticDict", "actorDict")
